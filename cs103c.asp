...
<div id="headlineBox"> <br>_______<br>
 <br>Expedite<br> Water Quality<br> Sampling<br>and<br>Reduce Errors<br>using
 <br>Flash-Based<br>Mapping Interface<br>_______<br></div>

 <div id="printBox">
<br><br><br><br><br><br><br><br> 
 <a href="c:/inetpub/wwwroot/library/Insurance/Insurance102CS-CompetitiveAdvantage.doc" target="_blank" class="documentLink">Printer Version<br>(Word Document)</a></div>
 </td> 
    ...
    <td id="csContentCell">		
	 ...
	 <script LANGUAGE="javascript"> 
	  ...
	  <p class="caseStudyHeading">
	  Municipal Water Provider  - Water Quality Sampling &amp; Permitting</p>
